package com.ruban.deployment.common.log.test;
...
//        System.out.println(sdf.format(new Date()));
        ...
        String line = null;
        Map<String, StoreStat> map = new HashMap<String, StoreStat>(200);
        Map<String, Integer> ipMap = new HashMap<String, Integer>(20000);
        Map<String, Integer> didMap = new HashMap<String, Integer>(20000);
        ...
        Map<String, String> nameMap = new HashMap<String, String>(300);
